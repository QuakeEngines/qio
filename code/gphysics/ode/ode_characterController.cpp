...
//
//
//void odeCharacterController_c::init(class odePhysicsWorld_c *pWorld, const class vec3_c &pos, float characterHeight, float characterWidth) {
//	this->myWorld = pWorld;
//
